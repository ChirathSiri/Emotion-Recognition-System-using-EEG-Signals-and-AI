...
def preprocessing_data(raw_data_file, file_type):
    try:
        ...
        if file_type == '.bdf':
            ...
            raw = mne.io.read_raw_egi(raw_data_file, preload=True)  # Update this line if the .mat file format is different
...
if __name__ == '__main__':
    ...
    # for i in files:
    raw_data_file = "/Users/chirathsirimanna/PycharmProjects/finalYearMlCode/Deap/Deap dataset/data_original/s08.bdf"
    raw_data = preprocessing_data(raw_data_file, ".bdf")
