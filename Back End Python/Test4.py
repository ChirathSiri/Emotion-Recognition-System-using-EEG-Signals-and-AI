...
if __name__ == '__main__':
    ...
    # for i in files:
    raw_data_file = "/Users/chirathsirimanna/PycharmProjects/finalYearMlCode/Deap/Deap dataset/data_original/s09.bdf"
    ...
    if raw_data is not None:
        ...
        if labels_for_feature is not None and data_for_feature is not None:
            ...
            train_and_save_model(result_rf)
            ...
            train_and_save_model(result_svm)
            ...
            train_and_save_model(result_knn)
