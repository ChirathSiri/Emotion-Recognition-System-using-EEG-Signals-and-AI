...
def feature_extraction(labels, data):
    ...
    np.save(
        "/Users/chirathsirimanna/PycharmProjects/finalYearMlCode/Deap/Deap dataset/New_PreProcessed_Python/eeg_band.npy",
        eeg_band)
...
def create_labels(eeg_band_data_):
    ...
    Valence describes the extent to which an emotion is positive or negative, whereas Arousal refers to its intensity,
    i.e., the strength of the associated emotional state.
    """
    ...
    np.save("/Users/chirathsirimanna/PycharmProjects/finalYearMlCode/Deap/Deap dataset/create_labels/labels.npy",
            data_with_labels)
...
def svm_classifier(data, labels):
    ...
    plot_confusion_matrix(y_test, predicted, classes=np.unique(emotion))
...
def random_forest_classifier(data, labels):
    ...
    # Plotting
    plot_confusion_matrix(y_test, y_pred, classes=np.unique(emotion))
...
if __name__ == '__main__':
    ...
    # for i in files:
    input_raw_data_file = "/Users/chirathsirimanna/PycharmProjects/finalYearMlCode/Deap/Deap dataset/data_original/s06.bdf"
    ...
    print("Part 1 Total execution time:", total_time, "seconds")
    ...
    if preprocessed_raw_data is not None:
        ...
        # Calculate the total time taken
        total_time = end_time - start_time
        print("Part 2 Total execution time:", total_time, "seconds")
        ...
        if labels_for_feature is not None and data_for_feature is not None:
            ...
            # Calculate the total time taken
            total_time = end_time - start_time
            print("Part 3 Total execution time:", total_time, "seconds")
            ...
            # Calculate the total time taken
            total_time = end_time - start_time
            print("Part 4 Total execution time:", total_time, "seconds")
            ...
            # Calculate the total time taken
            total_time = end_time - start_time
            print("Part RF Model Total execution time:", total_time, "seconds")
            ...
            # Calculate the total time taken
            total_time = end_time - start_time
            print("Part SVM Model Total execution time:", total_time, "seconds")
            ...
            # Calculate the total time taken
            total_time = end_time - start_time
            print("Part KNN Model Total execution time:", total_time, "seconds")
            ...
            total_time = end_time - start_time
            print("ACCURACY COMPARE Total execution time:", total_time, "seconds")


            # # Load saved models
            # RF_model = load_RF_model('/Users/chirathsirimanna/PycharmProjects/finalYearMlCode/RF_Model.pkl')
            # SVM_model = load_SVM_model('/Users/chirathsirimanna/PycharmProjects/finalYearMlCode/SVM_Model.pkl')
            # KNN_model = load_KNN_model('/Users/chirathsirimanna/PycharmProjects/finalYearMlCode/KNN_Model.pkl')
            #
            # # if RF_model and SVM_model and KNN_model:
            # #     # Load your test data
            # #     test_data = np.load('/path/to/your/test_data.npy')
            # #
            # #     # Make predictions
            # #     RF_predictions = predict_with_RF(RF_model, test_data)
            # #     SVM_predictions = predict_with_SVM(SVM_model, test_data)
            # #     KNN_predictions = predict_with_KNN(KNN_model, test_data)
            # #
            # #     # Example printout of predictions
