...
def preprocessing_data(raw_data_file = "/Users/chirathsirimanna/PycharmProjects/finalYearMlCode/Deap/Deap dataset/data_original/s01.bdf"):
...
def read_preprocessed_data():
    ...
    directory = "/Users/chirathsirimanna/PycharmProjects/finalYearMlCode/Deap/Deap dataset/data_preprocessed_matlab/"
    data = []
    labels = []
...
def feature_extraction(labels, data):
    ...
    # print(get_band_power(0, 31, "delta", eeg_data))
    print(get_band_power(0, 31, "theta", eeg_data))
    print(get_band_power(0, 31, "alpha", eeg_data))
    print(get_band_power(0, 31, "beta", eeg_data))
    print(get_band_power(0, 31, "gamma", eeg_data))
